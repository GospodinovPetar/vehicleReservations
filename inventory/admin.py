...
class VehicleAdmin(admin.ModelAdmin):
    list_display = ("name","type","engine_type","seats","unlimited_passengers","price_per_day","currency","created_at")
...
class ReservationAdmin(admin.ModelAdmin):
    list_display = ("id","user","vehicle","start_date","end_date","status","total_price","currency","created_at")
